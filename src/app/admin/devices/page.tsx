...
export default function DevicePage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      setPaginationMeta(
        deviceRes.data.meta?.pagination || {
          total: 0,
          totalPages: 1,
          hasNext: false,
          hasPrev: false,
  ...
  }, [sessionStatus, session, page, limit, sortBy, sortOrder, statusFilter]);
  ...
  const columns = useMemo<ColumnDef<Device>[]>(
    () => [
      ...
      },
      {
        id: "surveys",
        header: "Surveys",
        cell: (device) => device._count?.surveys ?? 0,
      },
      {
        id: "actions",
        header: "Actions",
    ...
    [isUpdating, openModal, getStatusBadgeClass]
  );
    ...
    <div className="p-4 md:p-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-6">
        <StatCard
          title="Total Devices"
          value={stats.total}
          icon={<PowerIcon className="text-gray-500" />}
        ...
        <StatCard
          title="Active"
          value={stats.active}
          icon={<PowerIcon className="text-green-500" />}
        ...
        <StatCard
          ...
          icon={<PowerOffIcon className="text-red-500" />}
        ...
        <StatCard
          ...
          icon={<SettingsIcon className="text-yellow-500" />}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
            <h2 className="font-semibold text-lg mb-4">
              Edit Device: {selectedDevice.name}
            </h2>
